  ...
  <div class="viewtransactionhistory">
    ...
    <div class="pagination">
      ...
      <button
        ...
        @click="(pageCount >= 5 ? (pageCount -= 5) : pageCount, (currentPage = pageCount + 5))"
      >
        <svg
          width="14"
          height="18"
      ...
      <button
        class="button--next"
        @click="
          (pageCount + 5 < maxPage ? (pageCount += 5) : pageCount, (currentPage = pageCount + 1))
        "
      >
        <svg
          width="14"
      ...
      <button
        class="button--rear"
        @click="((pageCount = Math.floor((maxPage - 1) / 5) * 5), (currentPage = maxPage))"
      >
        <svg
          width="20"
          height="18"
